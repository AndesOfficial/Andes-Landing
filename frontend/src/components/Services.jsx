...
const Services = () => {
  return (
    <div className="bg-brand text-white py-12 px-4 rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl transition-all duration-300 ease-in-out mx-auto max-w-7xl relative overflow-hidden">
