        ...
        <div className="container mx-auto px-6 md:px-12 md:pt-24 md:pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <FaCheckCircle className="text-brand text-6xl mx-auto mb-4" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <FaShippingFast className="text-brand text-6xl mx-auto mb-4" />
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">
                Ultra-Fast Delivery
              </h2>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <FaShieldAlt className="text-brand text-6xl mx-auto mb-4" />
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">
                Clothes Insurance
              </h2>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              <FaLeaf className="text-brand text-6xl mx-auto mb-4" />
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">
